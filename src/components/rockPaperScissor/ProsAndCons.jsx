import ProsConsIMG from "@assets/games/RockPaperScissorProsCons.jpg";
import ProsConsMobIMG from "@assets/games/RockPaperScissorProsConsMob.jpg";
import { FaThumbsUp, FaExclamationTriangle } from "react-icons/fa";

const ProsAndCons = () => {
  const pros = [
    {
      title: "Win value: high",
      description: "With a successful guess, you win two out of three groups of predictions."
    }
  ];
  ...
  const cons = [
    {
      title: "Risk: high",
      description: "There is only 33.33% chance to win the game."
    },
    {
      title: "Difficulty: high",
      description: "There are three options available to place your prediction."
    }
  ];
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="w-full md:w-1/2">
              <div className="rounded-[30px] overflow-hidden shadow-2xl border-4 border-primary-700/50">
                <img
                  src={ProsConsIMG}
                  alt="Rock Paper Scissor Game Analysis"
