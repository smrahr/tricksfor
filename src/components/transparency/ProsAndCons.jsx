...
const ProsAndCons = () => {
  const pros = [
    {
      title: "Transparency: very high",
      description: "All game results are verified on blockchain and publicly accessible."
    },
    {
      title: "Trust: very high",
      description: "Smart contracts ensure fairness and automatic payouts."
    }
  ];
  ...
  const cons = [
    {
      ...
      description: "Blockchain transactions require network fees."
    }
  ];
