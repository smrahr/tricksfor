    ...
    <div className="pt-[158px] m-5 md:pt-[0px]">
      ...
      <div className="p-5 flex flex-col md:flex-row items-start gap-2 md:gap-10 justify-start md:justify-between dark:bg-primary-800 rounded-bl-[50px] md:rounded-[50px]">
        <div className="pl-0 md:pl-10 w-full md:w-[48%]">
          ...
          Experience the thrill of our high-stakes Dice Game! Predict the outcome and engage with seamless crypto payments for a chance to win big. Are you ready to test your luck and strategy? 
          Here’s how it works:
          </p>
          <ul className="w-full list-disc text-[14px] pl-10">
            <li>
              ...
              <p>
                Players place their predictions on whether the dice will land on one to six.
              </p>
            </li>
            <li>
