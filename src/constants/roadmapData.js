...
export const roadmapData = [
  ...
  },
  {
    ...
    date: "Feature",
    title: "RPS Fire Mode",
    description: "Lauch Rock paper scissor fire game mode",
    status: ROADMAP_STATUS.FUTURE,
    icon: FaPlaneDeparture,
    className: "vertical-timeline-element--work",
    titleStyle: "text-[20px] font-bold",
  ...
  },
  {
    ...
    date: "Feature",
    title: "Tornoments",
    description: "Run tornoments for top rank players or owner of tornoment NFTs",
    status: ROADMAP_STATUS.FUTURE,
    icon: FaPlaneDeparture,
    className: "vertical-timeline-element--work",
    titleStyle: "text-[20px] font-bold",
  ...
  },
  {
    ...
    description: "Lauch Tricksfor token with the third phase of strategic game",
    status: ROADMAP_STATUS.IN_PROGRESS,
    icon: FaRocket,
    className: "vertical-timeline-element--education",
  },
